...
Earlier today Maxvoltar posted a simple jekyll-based photo sharing template up to Hacker News that I really liked.  It was a simple enough matter to fork it, add a small textual overlay to the images in the feed, and pipe in the exif data for a nice textual overlay.  I'll be posting photos to /photo-stream/ going forward.
