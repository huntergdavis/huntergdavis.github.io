...
So I finally sanitized my root fs and managed to get it down to about 200 megs, grab it [here](/zipit.tgz).  
 Todd got the correct keymap working in X, grab it[ here](/todd-zipit.tgz)  
 Todd built a battlevel ipkg , grab it[ here](/battlevel_1.0-r2.3_armv5te.ipk) (From Todd: “To get the battery meter to work I had to manually create some inodes, with: mknod /dev/i2c-0 c 89 0”)
