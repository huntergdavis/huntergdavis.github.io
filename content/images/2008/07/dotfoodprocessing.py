...
print breakfastCalo,"breakfast calories between",earliestHour,"and",breakfastEndsAt
print lunchCalo,"lunch calories between",breakfastEndsAt,"and",lunchEndsAt
print dinnerCalo,"dinner calories between",lunchEndsAt,"and",latestHour
print "-------------------------------"
